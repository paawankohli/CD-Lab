...
void expn()
{
	if(lookahead->type==8||lookahead->type==6)
	{
		...
		printf("\n error id or num expected");exit(0);
	}
}
void eprime()
{
...
void mulop()
{
	...
	{
		printf("\n error * or / or modulus op expected");exit(0);
	}
}*/
int main()
{
