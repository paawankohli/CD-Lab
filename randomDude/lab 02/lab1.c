...
int main(){
FILE *fa,*fb;
char types[][20]={"NO TOKEN", "ARITHMETIC OPERATOR", "RELATIONAL OPERATOR", "LOGICAL OPERATOR", "SPECIAL SYMBOL", "KEYWORD", "NUMBER", "STRING LITERAL", "IDENTIFIER", "SHORTHAND OPERATOR", "ASSIGNMENT OPERATOR","LB","RB","LC","RC"};
int l=1, c=0;
